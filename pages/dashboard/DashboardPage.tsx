    ...
    >
      ...
      <div className="space-y-3">
        {notes.map((note, index) => (
          <motion.div
            key={note.id}
            className="card bg-white hover:shadow-md hover:bg-gray-50 transition-all duration-200 p-6 border-l-4 border-l-primary/20"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {stats.map((stat, index) => (
          <motion.div
            ...
            className="card bg-white p-6 text-center hover:shadow-md hover:bg-gray-50 transition-all duration-200"
          >
